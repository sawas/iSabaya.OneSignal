...
namespace iSabaya.OneSignal.Notifications
{
    ...
    /// </summary>
    public class NotificationsRequest : WebAPIRequest, INotificationsRequest
    {
        /// <summary>
        /// Default constructor
        /// </summary>
        ...
        public NotificationsRequest(string apiKey, string apiUri, ProxyOptions proxyOptions) 
        ...
        public NotificationViewResult View(NotificationViewOptions options)
        {
            ...
            return new NotificationViewResult();
        }
        ...
        public NotificationCancelResult Cancel(NotificationCancelOptions options)
        {
            ...
            return new NotificationCancelResult();
        }
    }
